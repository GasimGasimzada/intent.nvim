local function create_color_scheme()
	...
	-- Neo-tree
	set_hl("NeoTreeNormal", { fg = colors.fg, bg = colors.bg_alt })
	set_hl("NeoTreeNormalNC", { fg = colors.fg, bg = colors.bg_alt })
	set_hl("NeoTreeCursorLine", { bg = colors.bg_alt2 })
	set_hl("NeoTreeIndentMarker", { fg = colors.border })
	set_hl("NeoTreeExpander", { fg = colors.fg_dim })
	set_hl("NeoTreeRootName", { fg = colors.fg_dim, bold = true })
	set_hl("NeoTreeDirectoryName", { fg = colors.fg_mid })
	set_hl("NeoTreeDirectoryIcon", { fg = colors.fg_mid })
	set_hl("NeoTreeFileName", { fg = colors.fg })
	set_hl("NeoTreeFileNameOpened", { fg = colors.orange_dim, bold = true })
	set_hl("NeoTreeDotfile", { fg = colors.fg_dim })
	set_hl("NeoTreeHiddenByName", { fg = colors.fg_dim })
	set_hl("NeoTreeSymbolicLinkTarget", { fg = colors.magenta })
	set_hl("NeoTreeTitleBar", { fg = colors.fg_dim, bg = colors.bg_alt2, bold = true })
	set_hl("NeoTreeFilterTerm", { fg = colors.orange_dim })
	set_hl("NeoTreeGitAdded", { fg = colors.green })
	set_hl("NeoTreeGitConflict", { fg = colors.red })
	set_hl("NeoTreeGitDeleted", { fg = colors.red })
	set_hl("NeoTreeGitIgnored", { fg = colors.fg_dim })
	set_hl("NeoTreeGitModified", { fg = colors.yellow })
	set_hl("NeoTreeGitRenamed", { fg = colors.blue })
